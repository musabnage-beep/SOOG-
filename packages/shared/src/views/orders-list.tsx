...
import type { LinkLike } from '../client/shell';
import {
  Card,
  CardBody,
  Input,
...
import { ORDER_STATUS_LABEL_AR, ORDER_STATUS_TONE, FULFILLMENT_LABEL_AR } from '../constants';
...
export function OrdersListView({
  ...
  return (
    <div>
      <PageHeader title="الطلبات" subtitle={subtitle} />
      ...
      <Card>
        <CardBody className="p-0">
          {isLoading ? (
            ...
            <EmptyState title="لا توجد طلبات" subtitle={emptySubtitle} />
          ) : (
            <>
              <Table>
                <THead>
